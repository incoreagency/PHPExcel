...
class PHPExcel
{
    ...
    */
     ...
     */
    public function getNamedRange($namedRange, PHPExcel_Worksheet|null $pSheet = null)
    {
        $returnValue = null;
     ...
     * @return PHPExcel
     */
    public function removeNamedRange($namedRange, PHPExcel_Worksheet|null $pSheet = null)
    {
        if ($pSheet === null) {
            if (isset($this->namedRanges[$namedRange])) {
